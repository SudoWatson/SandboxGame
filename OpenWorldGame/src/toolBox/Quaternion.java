...
public class Quaternion {
	...
	// This is all ThinMatrix (https://github.com/TheThinMatrix/OpenGL-Animation/blob/master/Animation/animation/Quaternion.java)
	// I have no sweet clue how quaternions work but they do so oh well
